...
= Recent Update in myCred =
myCred offers a robust Hooks system to automate and streamline rewards for user activities. With the latest enhancements, admins can reward users for viewing specific content or incentivize authors for content engagement.

= Key Highlights =
**Points for Viewing Specific Content (Members)** – Reward users for viewing specific posts, pages, or custom content types to drive engagement.
**Points for Viewing Specific Content (Authors)** – Motivate authors by assigning points for views on their posts, encouraging valuable content creation.
